...
public abstract class AbstractVaisseau extends Object {
        ...
        public AbstractVaisseau(String name,int nbmissile,int sheild,int status){
            this.name=name;
        ...
        public void  addnbMissiles(int nbr){
            ...
            if(total<0){
                ...
                if (total > be.technifutur.starwars.vaisseau.MAX_MISSILE)
                {
                    this.nbmissile= MAX_MISSILE;
                }
                else{
                    this.nbmissile=Math.min(be.technifutur.starwars.vaisseau.MAX_MISSILE,total);
                }
            }
        }
        ...
        public void sheildDown(int feu){
            ...
            if(sheild < 0){
                System.out.println(be.technifutur.starwars.AbstractVaisseau.this.name+" est détruit");
            }
        }
        ...
        public abstract void camps();
        @Override
   public String toString(){
        return "vaisseau "+name+" nombre de missile: "+nbmissile;
        }
